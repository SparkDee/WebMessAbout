...
//if(isset($_GET['yearform'])) {
    $searchyear = $_POST['yearform'];
    
    $endpoint="http://mdavidson04.lampt.eeecs.qub.ac.uk/webprojapi/api.php?year={$searchyear}";
...
<body>
<p class="lead">Albums Returned By Year <?php echo $searchyear?></p>
