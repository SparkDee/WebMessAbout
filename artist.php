...
$searchartist = $_POST['artistform'];
    
$endpoint="http://mdavidson04.lampt.eeecs.qub.ac.uk/webprojapi/api.php?artist={$searchartist}";
...
<body>
<p class="lead">Albums Returned By Artist: <?php echo $searchartist?></p>
